...
![Pasted image 20250604085342.png](/assets/img/attachments/Pasted%20image%2020250604085342.png)
...
![Pasted image 20250603231319.png](/assets/img/attachments/Pasted%20image%2020250603231319.png)

UDP扫描，端口开放情况如下

![Pasted image 20250603231930.png](/assets/img/attachments/Pasted%20image%2020250603231930.png)

开放端口常见漏洞扫描，80端口可能存在SQL注入，8080端口有个 Robots.txt 文件

![Pasted image 20250603232426.png](/assets/img/attachments/Pasted%20image%2020250603232426.png)

## Web 渗透

dirsearch 目录扫描发现 accss.html，猜测hash，识别为md5

![Pasted image 20250603233849.png](/assets/img/attachments/Pasted%20image%2020250603233849.png)
```txt
...
![Pasted image 20250603235459.png](/assets/img/attachments/Pasted%20image%2020250603235459.png)

尝试 ssh 登录，失败，应该是网站账户密码，还是失败

查看提示 8080端口开着 ~~http-proxy 我把它当代理了没访问~~ 访问后有一个登录框，第三个账号密码可以成功登录

 ![Pasted image 20250604001924.png](/assets/img/attachments/Pasted%20image%2020250604001924.png)

## 漏洞利用（获得初始立足点）

系统设置中，查看系统属性，具有一些插件，可能存在可利用漏洞

![Pasted image 20250604002733.png](/assets/img/attachments/Pasted%20image%2020250604002733.png)

Jenkins ver.2.113   插件 script-security 1.43    利用脚本 46453.py

![Pasted image 20250604003057.png](/assets/img/attachments/Pasted%20image%2020250604003057.png)
...
![Pasted image 20250604010827.png](/assets/img/attachments/Pasted%20image%2020250604010827.png)


由于利用脚本写的较早，jdk11不支持部分代码，执行失败，自己做更改(第三行)

![Pasted image 20250604010527.png](/assets/img/attachments/Pasted%20image%2020250604010527.png)
...
![Pasted image 20250604011656.png](/assets/img/attachments/Pasted%20image%2020250604011656.png)

![Pasted image 20250604011827.png](/assets/img/attachments/Pasted%20image%2020250604011827.png)

优化终端错误，原因是当前用户 Jenkins 权限/bin/false，无法使用交互式shell

![Pasted image 20250604013445.png](/assets/img/attachments/Pasted%20image%2020250604013445.png)!

![Pasted image 20250604085701.png](/assets/img/attachments/Pasted%20image%2020250604085701.png)
...
![Pasted image 20250604022503.png](/assets/img/attachments/Pasted%20image%2020250604022503.png)

对 crontab 较感兴趣，`cat /etc/crontab` 发现有一个以 root 权限每五分钟执行一个脚本的定时任务，`ls -l` 命令查看 Jarkin 是否具有写入权限

![Pasted image 20250604022923.png](/assets/img/attachments/Pasted%20image%2020250604022923.png)
...
![Pasted image 20250604023158.png](/assets/img/attachments/Pasted%20image%2020250604023158.png)

反弹 shell 连接成功，root权限，提权成功（music 起）

![Pasted image 20250604023403.png](/assets/img/attachments/Pasted%20image%2020250604023403.png)
